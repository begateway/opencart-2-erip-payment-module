...
* Загрузите файл модуля [opencart-erip-payment-module.zip](https://github.com/beGateway/opencart-2-erip-payment-module/raw/master/opencart-erip-payment-module.zip) с помощью _Модули_ -> _Установка расширений_
